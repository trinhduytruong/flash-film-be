...
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    keycloak_id VARCHAR(36)  NOT NULL UNIQUE COMMENT 'Keycloak User ID (sub claim)',
...
CREATE TABLE IF NOT EXISTS user_addresses (
    ...
    user_id         BIGINT       NOT NULL COMMENT 'Khóa ngoại trỏ đến bảng user_profiles',
...
CREATE TABLE IF NOT EXISTS media_files (
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_media_file_user FOREIGN KEY (user_id) REFERENCES user_profiles(id) ON DELETE SET NULL,
