package com.flash.film.module.auth.service.impl;
...
public class AuthServiceImpl implements AuthService {
        ...
        public void sendRegisterOtp(SendOtpRequest request) {
                ...
                redisService.set(redisKey, otpCode, 300);
        ...
        public User register(RegisterRequest request) {
                ...
                while (userRepository.existsByUsername(generatedUsername)) {
                        generatedUsername = baseUsername + "_" + new Random().nextInt(10000);
                }
                ...
                user.setJwtSecret(UUID.randomUUID().toString());
                user.setCreatedBy(generatedUsername);
        ...
        public LoginResponse login(LoginRequest request, HttpServletRequest httpRequest) {
                ...
                if (!passwordEncoder.matches(request.getPassword(), user.getPassword())) {
                        throw new CustomException(
                                        AppCode.UNAUTHORIZED, HttpStatus.UNAUTHORIZED, "Invalid email or password");
                }
